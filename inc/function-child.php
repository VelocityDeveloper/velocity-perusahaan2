	...
	function justg_widgets_init()
	{
		...
		register_sidebar(
			array(
				...
				'after_widget'  => '</aside>',
				'before_title'  => '<h3 class="widget-title">'.$icon.'<span>',
				'after_title'   => '</span></h3>',
				'show_in_rest'   => false,
			)
		);
...
if (!function_exists('justg_left_sidebar_check')) {
	function justg_left_sidebar_check()
	{
		...
		echo '<div class="right-sidebar widget-area ps-md-2 pe-md-0 col-sm-12 col-md-3 order-4" id="right-sidebar" role="complementary">';
